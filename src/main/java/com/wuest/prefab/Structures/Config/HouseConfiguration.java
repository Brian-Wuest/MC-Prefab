...
public class HouseConfiguration extends StructureConfiguration {
    ...
    private static void PlaceOutsideTorches(World world, BlockPos cornerPosition, HouseConfiguration configuration, Direction facing) {
        ...
        while (blocksMoved <= houseWidth) {
            ...
            if (world.isAirBlock(itemPosition) && Block.func_220055_a(world, itemPosition.offset(facing), facing)) {
                BuildingMethods.ReplaceBlock(world, itemPosition, blockState);
            }
        ...
        while (blocksMoved <= houseDepth) {
            ...
            if (world.isAirBlock(itemPosition) && Block.func_220055_a(world, itemPosition.offset(facing), facing.rotateY())) {
                BuildingMethods.ReplaceBlock(world, itemPosition, blockState);
            }
        ...
        while (blocksMoved <= houseDepth) {
            ...
            if (world.isAirBlock(itemPosition) && Block.func_220055_a(world, itemPosition.offset(facing), facing.rotateYCCW())) {
                BuildingMethods.ReplaceBlock(world, itemPosition, blockState);
            }
        ...
        while (blocksMoved <= houseWidth) {
            ...
            if (world.isAirBlock(itemPosition) && Block.func_220055_a(world, itemPosition.offset(facing), facing.getOpposite())) {
                BuildingMethods.ReplaceBlock(world, itemPosition, blockState);
            }
