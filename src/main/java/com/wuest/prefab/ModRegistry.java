...
public class ModRegistry {
	 ...
	 */
	private static <T extends Item> T GetItem(Class<T> genericClass) {
	 ...
	 */
	private static <T extends Block> T GetBlock(Class<T> genericClass) {
	 ...
	 */
	static void RegisterModComponents() {
	 ...
	 */
	private static <T extends Item> void registerItem(T item) {
	...
	private static <T extends Block> T registerBlock(T block) {
		return ModRegistry.registerBlock(block, Objects.requireNonNull(block.getRegistryName()).getPath());
	}
