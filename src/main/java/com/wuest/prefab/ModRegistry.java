...
public class ModRegistry
{
	...
	public static void RegisterRecipes()
	{
		...
		// Compressed Chest
		ModRegistry.addShapedRecipe("Compressed Chest", ModConfiguration.compressedChestKey, new ItemStack(ModRegistry.CompressedChestItem()),
				"xxx",
				"xyx",
				"xxx",
		...
		// Pile of Bricks
		ModRegistry.addShapedRecipe("Pile of Bricks From Bricks", ModConfiguration.pileOfBricksKey, new ItemStack(ModRegistry.PileOfBricks()),
				"xxx",
				"xxx",
				"xxx",
				'x', Items.BRICK);

		ModRegistry.addShapedRecipe("Pile of Bricks To Bricks", ModConfiguration.pileOfBricksKey, new ItemStack(Items.BRICK, 9),
				"x",
				'x', ModRegistry.PileOfBricks());

		// Pallet of Bricks
		ModRegistry.addShapedRecipe("Pile of Bricks To Pallet of Bricks", ModConfiguration.pileOfBricksKey, new ItemStack(ModRegistry.PalletOfBricks()),
				"xxx",
				"xxx",
				"xxx",
				'x', ModRegistry.PileOfBricks());

		ModRegistry.addShapedRecipe("Pallet of Bricks to Pile of Bricks", ModConfiguration.pileOfBricksKey, new ItemStack(ModRegistry.PileOfBricks(), 9),
				"x",
				'x', ModRegistry.PalletOfBricks());

		// Warehouse
		ModRegistry.addShapedRecipe("Warehouse", ModConfiguration.warehouseKey, new ItemStack(ModRegistry.WareHouse()),
				"x x",
				"xyx",
				"zaz",
		...
		ModRegistry.addShapedRecipe("Warehouse With Lanterns", ModConfiguration.warehouseKey, new ItemStack(ModRegistry.WareHouse()),
				"x x",
				"xyx",
				"zaz",
				'x', ModRegistry.GetCompressedStoneType(BlockCompressedStone.EnumType.DOUBLE_COMPRESSED_STONE),
		...
		// Produce Farm.
		ModRegistry.addShapedRecipe("Produce Farm", ModConfiguration.produceFarmKey, new ItemStack(ModRegistry.ProduceFarm()),
				"aba",
				"cdc",
				"aba",
		...
		ModRegistry.addShapedRecipe("Produce Farm With Lanterns", ModConfiguration.produceFarmKey, new ItemStack(ModRegistry.ProduceFarm()),
				"aba",
				"cdc",
				"aba",
				'a', ModRegistry.PalletOfBricks(),
		...
		// Tree Farm/Park
		ModRegistry.addShapedRecipe("Tree Farm", ModConfiguration.treeFarmKey, new ItemStack(ModRegistry.TreeFarm()),
				"aba",
				"cdc",
				"aba",
				'a', ModRegistry.PalletOfBricks(),
		...
		ModRegistry.addShapedRecipe("Tree Farm With Lanterns", ModConfiguration.treeFarmKey, new ItemStack(ModRegistry.TreeFarm()),
				"aba",
				"cdc",
				"aba",
				'a', ModRegistry.PalletOfBricks(),
		...
		// Chicken Coop
		ModRegistry.addShapedRecipe("Chicken Coop", ModConfiguration.chickenCoopKey, new ItemStack(ModRegistry.ChickenCoop()),
				"eee",
				"aba",
				"cdc",
		...
		// Fish farm.
		ModRegistry.addShapedRecipe("Fish Farm", ModConfiguration.fishFarmKey, new ItemStack(ModRegistry.FishPond()),
				"abc",
				"ded",
				"fgf",
		...
		// Warehouse Upgrade
		ModRegistry.addShapedRecipe("Warehouse Upgrade", ModConfiguration.warehouseUpgradeKey, new ItemStack(ModRegistry.WareHouseUpgrade()),
				"aba",
				"cdc",
				"aba",
		...
		// Advanced Warehouse
		ModRegistry.addShapedRecipe("Advanced Warehouse", ModConfiguration.advancedWarehouseKey, new ItemStack(ModRegistry.AdvancedWareHouse()),
				"xbx",
				"xyx",
				"zaz",
				'x', ModRegistry.GetCompressedStoneType(BlockCompressedStone.EnumType.DOUBLE_COMPRESSED_STONE),
		...
		ModRegistry.addShapedRecipe("Advanced Warehouse With Lanterns", ModConfiguration.advancedWarehouseKey, new ItemStack(ModRegistry.AdvancedWareHouse()),
				"xbx",
				"xyx",
				"zaz",
				'x', ModRegistry.GetCompressedStoneType(BlockCompressedStone.EnumType.DOUBLE_COMPRESSED_STONE),
		...
		// Monster Masher.
		ModRegistry.addShapedRecipe("Monster Masher", ModConfiguration.monsterMasherKey, new ItemStack(ModRegistry.MonsterMasher()),
				"abc",
				"ede",
				"fgh",
		...
		IRecipe currentRecipe = new ShapedOreRecipe(new ResourceLocation(Prefab.MODID, ModConfiguration.bundleofTimberKey), ModRegistry.BundleOfTimber(), 
				"aaa", 
				"aaa", 
				"aaa", 
				'a', "logWood");
		...
		ModRegistry.SaveModRecipe(ModConfiguration.bundleofTimberKey, currentRecipe.getRegistryName());

		// Bundle of timber to oak planks.
		ModRegistry.addShapedRecipe("Bundle of Timber To Logs", ModConfiguration.bundleofTimberKey, new ItemStack(Item.getItemFromBlock(Blocks.LOG), 9), 
				"a",
				'a', ModRegistry.BundleOfTimber());

		// Horse Stable.
		ModRegistry.addShapedRecipe("Horse Stable Spruce", ModConfiguration.horseStableKey, new ItemStack(ModRegistry.HorseStable()),
				"aaa",
				"bcb",
				"ded",
		...
		ModRegistry.addShapedRecipe("Horse Stable Oak", ModConfiguration.horseStableKey, new ItemStack(ModRegistry.HorseStable()),
				"aaa",
				"bcb",
				"ded",
				'a', Item.getItemFromBlock(Blocks.BRICK_BLOCK),
		...
		ModRegistry.addShapedRecipe("Horse Stable Birch", ModConfiguration.horseStableKey, new ItemStack(ModRegistry.HorseStable()),
				"aaa",
				"bcb",
				"ded",
				'a', Item.getItemFromBlock(Blocks.BRICK_BLOCK),
		...
		ModRegistry.addShapedRecipe("Horse Stable Acacia", ModConfiguration.horseStableKey, new ItemStack(ModRegistry.HorseStable()),
				"aaa",
				"bcb",
				"ded",
				'a', Item.getItemFromBlock(Blocks.BRICK_BLOCK),
		...
		ModRegistry.addShapedRecipe("Horse Stable Jungle", ModConfiguration.horseStableKey, new ItemStack(ModRegistry.HorseStable()),
				"aaa",
				"bcb",
				"ded",
				'a', Item.getItemFromBlock(Blocks.BRICK_BLOCK),
		...
		ModRegistry.addShapedRecipe("Horse Stable Dark Oak", ModConfiguration.horseStableKey, new ItemStack(ModRegistry.HorseStable()),
				"aaa",
				"bcb",
				"ded",
				'a', Item.getItemFromBlock(Blocks.BRICK_BLOCK),
		...
		// Nether Gate
		ModRegistry.addShapedRecipe("Nether Gate", ModConfiguration.netherGateKey, new ItemStack(ModRegistry.NetherGate()),
				"aba",
				"bcb",
				"aba",
		...
		ModRegistry.addShapelessRecipe("Advanced Chicken Coop", ModConfiguration.advancedChickenCoopKey, result, ModRegistry.ChickenCoop(), ModRegistry.PalletOfBricks());
		...
		ModRegistry.addShapelessRecipe("Advanced Horse Stable", ModConfiguration.advancedHorseStableKey, result, 
		...
		ModRegistry.addShapelessRecipe("Advanced Horse Stable With Lanterns", ModConfiguration.advancedHorseStableKey, result, 
				ModRegistry.HorseStable(), ModRegistry.HorseStable(), ModRegistry.HorseStable(), ModRegistry.HorseStable(),
		...
		ModRegistry.addShapedRecipe("Barn", ModConfiguration.barnKey, result,
				"aba",
				"ccc",
				"cdc",
				'a', ModRegistry.PalletOfBricks(),
		...
		ModRegistry.addShapedRecipe("Machinery Tower", ModConfiguration.machineryTowerKey, result, 
				"aaa",
				" b ",
				" c ",
		...
		ModRegistry.addShapedRecipe("Defense Bunker", ModConfiguration.defenseBunkerKey, result, 
				"dad",
				"bcb",
				"ddd",
		...
		ModRegistry.addShapedRecipe("Mineshaft Entrance", ModConfiguration.mineshaftEntranceKey, result, 
				"dad",
				"bcb",
				"aaa",
				'a', ModRegistry.BundleOfTimber(),
		...
		ModRegistry.addShapedRecipe("Ender Gateway", ModConfiguration.enderGatewayKey, result, 
				"bdb",
				"dcd",
				"bab",
				'a', ModRegistry.GetCompressedStoneType(BlockCompressedStone.EnumType.TRIPLE_COMPRESSED_STONE),
		...
		ModRegistry.addShapedRecipe("Aqua Base", ModConfiguration.aquaBaseKey, result, 
				"xxx",
				"yzy",
				"yay",
		...
		ModRegistry.addShapedRecipe("Grassy Plains", ModConfiguration.grassyPlainsKey, result, 
				"   ",
				"yyy",
				"xxx",
		...
		ModRegistry.addShapedRecipe("Magic Temple", ModConfiguration.magicTempleKey, result, 
				"aaa",
				"cbd",
				"aaa",
		...
		// Instant Bridge.
		ModRegistry.addShapedRecipe("Instant Bridge", ModConfiguration.instantBridgeKey, 
		...
		// Paper Lantern.
		ModRegistry.addShapelessRecipe("Paper Lantern", ModConfiguration.paperLanternKey,  
				new ItemStack(Item.getItemFromBlock(ModRegistry.PaperLantern())), 
				Items.STICK, 
				Items.PAPER, 
				Item.getItemFromBlock(Blocks.TORCH));

		// String of lanterns (compressed paper lanterns).
		ModRegistry.addShapedRecipe("Lanterns to String of Lanterns", ModConfiguration.paperLanternKey,  
		...
		ModRegistry.addShapelessRecipe("Lanterns from String of Lanterns", ModConfiguration.paperLanternKey,  
		...
		ModRegistry.addShapedRecipe("Coil of Lanterns from String of lanterns", ModConfiguration.paperLanternKey,  
		...
		ModRegistry.addShapelessRecipe("Coil of Lanterns to String of lanterns", ModConfiguration.paperLanternKey, 
				new ItemStack(ModRegistry.StringOfLanterns(), 9), ModRegistry.CoilOfLanterns());

		// Compressed Obsidian.
		ModRegistry.addShapedRecipe("Compressed Obsidian", ModConfiguration.compressedObsidianKey, 
		...
		ModRegistry.addShapelessRecipe("Compressed Obsidian To Obsidian", ModConfiguration.compressedObsidianKey,
				new ItemStack(Item.getItemFromBlock(Blocks.OBSIDIAN), 9), 
				new ItemStack(Item.getItemFromBlock(ModRegistry.CompressedObsidianBlock()), 1, BlockCompressedObsidian.EnumType.COMPRESSED_OBSIDIAN.getMetadata()));

		// Double compressed obsidian.
		ModRegistry.addShapedRecipe("Double Compressed Obsidian", ModConfiguration.compressedObsidianKey, 
		...
		ModRegistry.addShapelessRecipe("Compressed Obsidian From Double Compressed", ModConfiguration.compressedObsidianKey, 
		...
		// Villager Houses.
		ModRegistry.addShapedRecipe("Villager Houses", ModConfiguration.villagerHousesKey, new ItemStack(ModRegistry.VillagerHouses()),
				"aaa",
				"aaa",
				"bbb",
				'a', ModRegistry.BundleOfTimber(),
		...
		// Phasic Block
		ModRegistry.addShapedRecipe("Phasic Block", ModConfiguration.phasicBlockKey, new ItemStack(ModRegistry.PhasingBlock()),
				"aaa",
				"aba",
				"aaa",
		...
		// Smart Glass
		ModRegistry.addShapedRecipe("Smart Glass", ModConfiguration.smartGlassKey, new ItemStack(ModRegistry.BoundaryBlock()),
				"aaa",
				"aba",
				"aaa",
