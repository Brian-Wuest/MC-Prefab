...
public class VillagerHouseConfiguration extends StructureConfiguration {
    ...
    protected NBTTagCompound CustomWriteToCompoundNBT(NBTTagCompound tag) {
        ...
        tag.setString(VillagerHouseConfiguration.bedColorTag, this.bedColor.getName().toUpperCase());
        return tag;
    }
    ...
    protected void CustomReadFromNBTTag(NBTTagCompound messageTag, StructureConfiguration config) {
        ...
        if (messageTag.hasKey(VillagerHouseConfiguration.bedColorTag)) {
            houseConfiguration.bedColor = EnumDyeColor.valueOf(messageTag.getString(VillagerHouseConfiguration.bedColorTag));
        }
    }
     ...
     */
    @Override
    public VillagerHouseConfiguration ReadFromCompoundNBT(NBTTagCompound messageTag) {
