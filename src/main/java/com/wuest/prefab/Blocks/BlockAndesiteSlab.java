 ...
 *
 */
public abstract class BlockAndesiteSlab extends BlockSlab
{
	/**
	...
	{
		return ((BlockStone) Blocks.STONE).getMapColor(Blocks.STONE.getStateFromMeta(BlockStone.EnumType.ANDESITE_SMOOTH.getMetadata()), worldIn, pos);
	}
	...
	{
		return Item.getItemFromBlock(ModRegistry.AndesiteSlab());
	}
