...
public class BasicStructureConfiguration extends StructureConfiguration {
    ...
    public enum EnumBasicStructureName {
         ...
         */
        private EnumBasicStructureName(String name, String unlocalizedName, String assetLocation, String topDownPictureLocation, String resourceLocation, int imageHeight,
                                       int imageWidth) {
            this.name = name;
